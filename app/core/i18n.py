...
STR = {
    ...
    "sec_files": {"en": "Files", "ar": "الملفات"},
    "sec_export": {"en": "Export", "ar": "التصدير"},
    "files_title": {"en": "Files & documents", "ar": "الملفات والمستندات"},
    "files_note": {"en": "Attach supporting documents to this session. Stored with the session; anyone who can open it can download them.",
                   "ar": "أرفق مستندات داعمة لهذه الجلسة. تُحفظ مع الجلسة ويمكن لمن يفتحها تنزيلها."},
    "files_upload": {"en": "Upload files / documents", "ar": "رفع ملفات / مستندات"},
    "files_none": {"en": "No files attached yet.", "ar": "لا توجد ملفات مرفقة بعد."},
    "files_download": {"en": "Download", "ar": "تنزيل"},
    "files_remove": {"en": "Remove", "ar": "إزالة"},
    "files_added": {"en": "Added {n} file(s).", "ar": "تمت إضافة {n} ملف/ملفات."},
    ...
    "spike_senders": {"en": "Top senders that month: From Counterparty to POI",
                      "ar": "أبرز المرسلين في ذلك الشهر: من الطرف المقابل إلى الشخص"},
    "spike_bens": {"en": "Top beneficiaries that month: From POI to Counterparty",
                   "ar": "أبرز المستفيدين في ذلك الشهر: من الشخص إلى الطرف المقابل"},
    # counterparties
    ...
    "cp_functions": {"en": "Details From OSINT", "ar": "تفاصيل من المصادر المفتوحة (OSINT)"},
    "cp_fill": {"en": "keep empty — I will fill it", "ar": "اتركه فارغًا — سأملؤه"},
    "cp_osint": {"en": "OSINT data found", "ar": "تم العثور على بيانات OSINT"},
    "cp_osint_filter": {"en": "OSINT", "ar": "OSINT"},
    "cp_osint_all": {"en": "All", "ar": "الكل"},
    "cp_osint_yes": {"en": "With OSINT", "ar": "مع OSINT"},
    "cp_osint_no": {"en": "Without OSINT", "ar": "بدون OSINT"},
    "cp_in": {"en": "Total inbound", "ar": "إجمالي الوارد"},
    "cp_out": {"en": "Total outbound", "ar": "إجمالي الصادر"},
    "cp_count": {"en": "counterparties", "ar": "طرفًا"},
    "cp_search": {"en": "Search name or account", "ar": "ابحث بالاسم أو الحساب"},
    "cp_type_filter": {"en": "Type", "ar": "النوع"},
    "cp_type_all": {"en": "All", "ar": "الكل"},
    "cp_type_company": {"en": "Company", "ar": "شركة"},
    "cp_type_person": {"en": "Person", "ar": "شخص"},
    "cp_type_unknown": {"en": "Unknown", "ar": "غير معروف"},
    "cp_ev_in": {"en": "Inbound evidence", "ar": "أدلة الوارد"},
    "cp_ev_out": {"en": "Outbound evidence", "ar": "أدلة الصادر"},
    ...
    "login_hint": {"en": "Contact your administrator if you need access.",
                   "ar": "تواصل مع المسؤول إذا كنت بحاجة إلى صلاحية الدخول."},
    "default_pw_warn": {"en": "Default admin password in use — set AML_ADMIN_PASSWORD "
                              "and change it from the Admin panel.",
                        "ar": "يُستخدم رمز مرور المسؤول الافتراضي — اضبط AML_ADMIN_PASSWORD "
                              "وغيّره من لوحة المسؤول."},
    "logout": {"en": "Sign out", "ar": "تسجيل الخروج"},
    # session manager
    "my_sessions": {"en": "My sessions", "ar": "جلساتي"},
    "all_sessions": {"en": "All sessions", "ar": "كل الجلسات"},
    ...
    "confirm_delete": {"en": "Yes, delete", "ar": "نعم، احذف"},
    "session_deleted": {"en": "Session deleted.", "ar": "تم حذف الجلسة."},
    "owner": {"en": "Owner", "ar": "المالك"},
    "saved_hint": {"en": "Your work autosaves to this session.", "ar": "يُحفظ عملك تلقائيًا في هذه الجلسة."},
    # admin
    "admin_panel": {"en": "Admin", "ar": "المسؤول"},
    "manage_users": {"en": "Users", "ar": "المستخدمون"},
    "add_user": {"en": "Add user", "ar": "إضافة مستخدم"},
    "new_username": {"en": "Username", "ar": "اسم المستخدم"},
    "new_password": {"en": "Password", "ar": "كلمة المرور"},
    "reset_pw": {"en": "Reset password", "ar": "إعادة تعيين كلمة المرور"},
    "delete_user": {"en": "Delete user", "ar": "حذف مستخدم"},
    "wipe_db": {"en": "Danger zone — wipe all sessions & data", "ar": "منطقة خطر — مسح كل الجلسات والبيانات"},
    "wipe_phrase": {"en": "Type DELETE ALL to confirm (user accounts are kept)",
                    "ar": "اكتب DELETE ALL للتأكيد (تُحفظ حسابات المستخدمين)"},
    "wipe_btn": {"en": "Wipe all data", "ar": "مسح كل البيانات"},
    "wipe_done": {"en": "All sessions and data wiped.", "ar": "تم مسح كل الجلسات والبيانات."},
    # counterparty lookup
    "lookup_title": {"en": "Counterparty lookup", "ar": "بحث عن طرف مقابل"},
    "lookup_pick": {"en": "Account # or name", "ar": "رقم الحساب أو الاسم"},
    "lookup_ph": {"en": "Type an account (e.g. CP-4107) or name…", "ar": "اكتب رقم حساب (مثل CP-4107) أو اسمًا…"},
    "lookup_none": {"en": "Pick an account to see its counterparty card.",
                    "ar": "اختر حسابًا لعرض بطاقة الطرف المقابل."},
    # accounts details
    ...
    "display_settings": {"en": "Display", "ar": "العرض"},
    "disp_tabs": {"en": "Tabs", "ar": "التبويبات"},
    "disp_charts": {"en": "Charts & tables", "ar": "الرسوم والجداول"},
    "disp_kpis": {"en": "Statistics (KPIs)", "ar": "الإحصاءات"},
    "disp_risk": {"en": "Risk score", "ar": "درجة المخاطر"},
    "disp_show_risk": {"en": "Show risk score", "ar": "إظهار درجة المخاطر"},
    "disp_hint": {"en": "Uncheck to hide; changes are saved with the session.",
                  "ar": "ألغِ التحديد للإخفاء؛ تُحفظ التغييرات مع الجلسة."},
    "hide_el": {"en": "Hide", "ar": "إخفاء"},
